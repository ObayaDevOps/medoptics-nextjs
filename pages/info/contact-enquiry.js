...
export default function ContactFormWithSocialButtons() {
  const { hasCopiedEmail, onCopyEmail } = useClipboard('info@medoptics.com');
  const { hasCopiedPhone, onCopyPhone } = useClipboard('0414 340 099');
  const { hasCopiedWA, onCopyWA } = useClipboard('+256706131219');
...
<Head>
      <title>Contact Us | MedOptics Ltd</title>
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 10 }}>
            ...
            <Stack
              ...
              <Stack
                ...
                {/* <Tooltip
                  label={hasCopiedEmail ? 'Email Copied!' : 'Copy Email - info@medoptics.com'}
                  closeOnClick={false}
                  hasArrow>
                  <IconButton
                    aria-label="email"
                ...
                <Tooltip
                  label={hasCopiedPhone ? 'Number Copied!' : 'Copy Number  - 0414 340 099'}
                  closeOnClick={false}
                  hasArrow>
                  <IconButton
                    aria-label="phone"
                ...
                <Tooltip
                  label={hasCopiedWA ? 'Number Copied!' : 'Copy Whats App  - +256706131219'}
                  closeOnClick={false}
                  hasArrow>
                  <IconButton
                    aria-label="whatsapp"
                ...
                <Link href="https://www.instagram.com/medopticsltd/">
                  <IconButton
                ...
                <Link href="https://www.facebook.com/MedOpticsLtd/">
                  <IconButton
                    aria-label="facebook"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://twitter.com/OpticsMed">
                  <IconButton
                    aria-label="twitter"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://www.linkedin.com/company/med-optics-vision-centre/">
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
