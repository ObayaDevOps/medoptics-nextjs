...
import { BsGithub, BsLinkedin, BsPerson, BsTwitter, BsWhatsapp, BsPhone } from 'react-icons/bs';
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            <Stack
              ...
              <Stack
                ...
                <Tooltip
                  label={hasCopied ? 'Email Copied!' : 'Copy Email - info@medoptics.com'}
                  closeOnClick={false}
                  hasArrow>
                  <IconButton
                    aria-label="email"
                ...
                <Tooltip
                  label={hasCopied ? 'Number Copied!' : 'Copy Number  - 0414 340 099'}
                  closeOnClick={false}
                  hasArrow>
                  <IconButton
                    aria-label="phone"
                ...
                <Tooltip
                  label={hasCopied ? 'Number Copied!' : 'Copy Whats App  - +256706131219'}
                  closeOnClick={false}
                  hasArrow>
                  <IconButton
                    aria-label="whatsapp"
